...
import {TopicsScreen, SearchingScreen,SettingScreen, HomeScreen, SurahScreen} from '../screen/index';
...
const TabBarNavigation = () => {
    ...
    return(
        <SearchStack.Navigator initialRouteName="SplashScreen">
            <SearchStack.Screen  name="SearchingScreen" component={SearchingScreen} />
    ...
    function TopicTab() {
        ...
        <TopicStack.Navigator initialRouteName="SplashScreen">
            <TopicStack.Screen  name="TopicScreen" component={TopicsScreen} options={{ header: () => null}} />
    ...
    return(
        <SettingStack.Navigator initialRouteName="SplashScreen">
            <SettingStack.Screen  name="SettingScreen" component={SettingScreen} options={{ header: () => null}} />
